<x-order-manager-layout>
    <x-slot name="header">
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h2 class="text-2xl font-bold text-gray-800" style="font-family: 'Playfair Display', serif;">Edit Shipping Discount Rule</h2>
                <p class="text-sm text-gray-500">Update shipping discount rule configuration</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <form action="{{ route('order-manager.shipping-discounts.update', $rule->id) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
                    ...
                    <div>
                        ...
                        <select name="region_id"
                            ...
                            @foreach($regions as $region)
                                <option value="{{ $region->id }}" {{ old('region_id', $rule->region_id) == $region->id ? 'selected' : '' }}>
                                    {{ $region->region_name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description"
                              ...
                              placeholder="Brief description of this rule">{{ old('description', $rule->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number"
                                   ...
                                   value="{{ old('min_order_weight', $rule->min_order_weight) }}"
                                   step="0.01"
                                   min="0"
                                   required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                        <div>
                            ...
                            <select name="rice_product_id"
                                ...
                                @foreach($products as $product)
                                    <option value="{{ $product->id }}" {{ old('rice_product_id', $rule->rice_product_id) == $product->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="number"
                                   ...
                                   value="{{ old('rice_weight_per_unit', $rule->rice_weight_per_unit) }}"
                                   step="0.01"
                                   min="0"
                                   required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number"
                                   ...
                                   id="min_rice_count"
                                   name="min_rice_count"
                                   value="{{ old('min_rice_count', $rule->min_rice_count) }}"
                                   min="0"
                                   required>
                        ...
                        <div>
                            ...
                            <input type="number"
                                   ...
                                   id="max_rice_count"
                                   name="max_rice_count"
                                   value="{{ old('max_rice_count', $rule->max_rice_count) }}"
                                   min="0"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                        <div>
                            ...
                            <input type="number"
                                   ...
                                   value="{{ old('discount_percentage', $rule->discount_percentage) }}"
                                   min="0"
                                   max="100"
                                   required>
                        ...
                        <div>
                            ...
                            <input type="number"
                                   ...
                                   value="{{ old('max_weight_limit', $rule->max_weight_limit) }}"
                                   step="0.01"
                                   min="0"
