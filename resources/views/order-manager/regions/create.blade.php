<x-order-manager-layout>
    <x-slot name="header">
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h2 class="text-2xl font-bold text-gray-800" style="font-family: 'Playfair Display', serif;">Add New Region</h2>
                <p class="text-sm text-gray-500">Create a new delivery region</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <form action="{{ route('order-manager.regions.store') }}" method="POST" class="p-6">
                @csrf
