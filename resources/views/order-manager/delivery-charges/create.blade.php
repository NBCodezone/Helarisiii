<x-order-manager-layout>
    <x-slot name="header">
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h2 class="text-2xl font-bold text-gray-800" style="font-family: 'Playfair Display', serif;">Add Delivery Charge</h2>
                <p class="text-sm text-gray-500">Create new ken delivery pricing</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <form action="{{ route('order-manager.delivery-charges.store') }}" method="POST" class="p-6">
                @csrf
