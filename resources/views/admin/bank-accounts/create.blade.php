    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-800" style="font-family: 'Playfair Display', serif;">Add Bank Account</h2>
                    <p class="text-sm text-gray-500">Add a new bank account for receiving payments</p>
                </div>
            </div>
        ...
        <form action="{{ route('admin.bank-accounts.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="additional_info" id="additional_info" rows="4"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent @error('additional_info') border-red-500 @enderror">{{ old('additional_info') }}</textarea>
