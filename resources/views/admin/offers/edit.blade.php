...
<div class="max-w-4xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Edit Product Offer</h1>
    ...
    <div class="bg-white rounded-xl shadow-md p-8">
        <form action="{{ route('admin.offers.update', $offer) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" class="w-full px-4 py-3 border @error('title') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition" id="title" name="title" value="{{ old('title', $offer->title) }}" placeholder="e.g., Find The Best Watches for You!" required>
                @error('title')
            ...
            <div class="mb-6">
                ...
                <input type="text" class="w-full px-4 py-3 border @error('product_name') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition" id="product_name" name="product_name" value="{{ old('product_name', $offer->product_name) }}" placeholder="e.g., Smart Watch" required>
                @error('product_name')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="number" class="w-full px-4 py-3 border @error('discount_percentage') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition" id="discount_percentage" name="discount_percentage" value="{{ old('discount_percentage', $offer->discount_percentage) }}" min="0" max="100" placeholder="e.g., 20" required>
            ...
            <div class="mb-6">
                ...
                <input type="number" class="w-full px-4 py-3 border @error('order') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition" id="order" name="order" value="{{ old('order', $offer->order) }}" min="0">
            ...
            <div class="flex justify-end space-x-4">
                ...
                <button type="submit" class="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-8 py-3 rounded-lg shadow-md hover:shadow-lg transition duration-200">Update Product Offer</button>
            </div>
        </form>
    </div>
</div>
