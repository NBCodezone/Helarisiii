...
<div class="rounded mb-4 position-relative">
    <img src="{{ asset('Electro-Bootstrap-1.0.0/img/product-banner-3.jpg') }}" class="img-fluid rounded w-100" style="height: 250px;" alt="Image">
    <div class="position-absolute rounded d-flex flex-column align-items-center justify-content-center text-center"
        ...
        <a href="{{ route('shop') }}" class="btn btn-primary rounded-pill">Shop Now</a>
    </div>
</div>
<!-- Shop Banner End -->
